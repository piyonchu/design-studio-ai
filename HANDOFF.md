...
## Code map
- `backend/src/routes/` — `auth, workspaces, projects, canon, assets, audio, collections, comments, lineage, export, search, context, recipes` · pack registry in `src/verticals.rs`.
